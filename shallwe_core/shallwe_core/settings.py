...
# It is generated/updated automatically by running ./envconfig/parse_to_constants.py as a script
from .envconfig.envconstants import *


SHALLWE_BACKEND_VERSION = '0.7.1-qa'
...
# Additional static directories to collect
STATICFILES_DIRS = []

# Define the target directory for static files
STATIC_ROOT = BASE_DIR / 'staticfiles'

STATIC_URL = '/static/'

# Define the target directory for media files
...
# Cookies
if SHALLWE_GLOBAL_ENV_MODE != 'DEV':
    SESSION_COOKIE_SAMESITE = SHALLWE_BACKEND_CREDENTIALS_COOKIE_SAMESITE
    SESSION_COOKIE_SECURE = SHALLWE_BACKEND_CRENEDTIALS_COOKIE_SECURE
    SESSION_COOKIE_DOMAIN = SHALLWE_BACKEND_CREDENTIALS_COOKIE_DOMAIN
    CSRF_COOKIE_SAMESITE = SHALLWE_BACKEND_CREDENTIALS_COOKIE_SAMESITE
    CSRF_COOKIE_SECURE = SHALLWE_BACKEND_CRENEDTIALS_COOKIE_SECURE
