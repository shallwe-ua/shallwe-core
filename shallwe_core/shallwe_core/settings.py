...
SHALLWE_BACKEND_VERSION = '0.7.1a4'
...
if SHALLWE_GLOBAL_ENV_MODE != 'DEV':
    ...
    SESSION_COOKIE_SECURE = SHALLWE_BACKEND_CREDENTIALS_COOKIE_SECURE
    ...
    CSRF_COOKIE_SECURE = SHALLWE_BACKEND_CREDENTIALS_COOKIE_SECURE
